...
Mifune maintains the MIT-licensed open-source Open Harness project, operates Open Harness Cloud as the managed path, and offers forward-deployed engineering support to Cloud customers.
...
The MIT-licensed project is for teams that want to inspect, adapt, and operate Open Harness themselves, locally or on a remote VM.
