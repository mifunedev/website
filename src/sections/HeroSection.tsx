        ...
        <div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.div
              ...
              className="mb-8 flex flex-col flex-wrap items-center gap-4 sm:flex-row lg:items-start"
            >
              <a
                href="#audit"
              ...
              <a
                href="#pain"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-border px-8 py-4 font-montserrat text-lg font-medium text-foreground transition-all duration-200 hover:border-green-500/50 hover:bg-green-500/5 whitespace-nowrap"
              >
